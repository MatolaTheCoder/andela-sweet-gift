                            ...
                            <table className="w-full border-collapse bg-white shadow-sm rounded-lg ">
                                <thead>
                                    <tr className="bg-gray-200 text-gray-700 border-b">
                                        ...
                                        <th className="text-[12px] uppercase tracking-wide font-medium py-3 px-4 text-left">Nome do destinatario</th>
                                        ...
                                        <th className="text-[12px] uppercase tracking-wide font-medium py-3 px-4 text-left">Quantidade</th>
                                        <th className="text-[12px] uppercase tracking-wide font-medium py-3 px-4 text-left">Valor</th>
                                        <th className="text-[12px] uppercase tracking-wide font-medium py-3 px-4 text-left">Opcoes</th>
                                    </tr>
                                </thead>
                                <tbody className="text-gray-700">
                                    {encomendas.map((data, index) => (
                                        <tr
                                            key={data.id}
                                        ...
                                        >
                                            ...
                                            <td className="py-3 px-4 border-b flex justify-center items-center gap-2">
                                                <Link
                                                    to="#"
